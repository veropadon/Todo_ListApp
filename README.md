...
A simple Todo List application demonstrating the use of various technologies.
...
- **PostgreSQL with TypeORM**: For the database, using TypeORM to interact with PostgreSQL.
